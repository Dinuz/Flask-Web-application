...
class RegistrationForm(Form):
    ...
    accept_tos = BooleanField(
        'I accept the <a href="/about/tos" target="blank">Terms of Service</a> and <a href="/about/privacy-policy" target="blank">Privacy Notice</a> (updated Jan 22, 2015)',
        [validators.Required()])
    ...
    try:
        try:
            ...
            if client_name == "Guest":
                flash(
                    "Welcome Guest, feel free to browse content. Progress tracking is only available for Logged-in users.")
                tracking = ['None']
            ...
            return render_template("dashboard.html", topics=TOPIC_DICT, tracking=tracking,
